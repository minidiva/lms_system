    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.UserRegistrationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/entity.CourseAggregate"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entity.ChapterInfoAggregate"
                            }
                        }
                    },
                    "400": {
        ...
        "/user/change-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Current\u0026New Password  credentials",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/user/courses/buy": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Course ID to buy",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.BuyCourseRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.BuyCourseRequest": {
            ...
            "properties": {
                ...
                "userUUID": {
                    "description": "← UUID напрямую из Keycloak, не приходит из JSON",
                    "type": "string"
                }
            }
        },
